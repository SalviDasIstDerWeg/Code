        ...
        dcc.Tabs(id="tabs", children=[
            ...
            dcc.Tab(label='Tab Two', id="tab_2_graphs", children=[
                html.Div([
                    ...
                    dbc.Row([
                        dbc.Col(html.Div([dbc.Label("Number of bins:", html_for="graph_5_nbins"),
...
@app.callback([Output("graph_3", "figure"), Output("graph_4", "figure"), Output('cluster_table', 'children')], Input("graph_3", "relayoutData"))
