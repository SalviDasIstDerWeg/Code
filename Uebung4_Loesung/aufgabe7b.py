...
app.layout = html.Div([
    ...
    html.Div([dcc.Tabs(id="tabs", children=[
        dcc.Tab(label='Tab One', id="tab_1_graphs", children=[
            html.Div([
                dbc.Row([
                    ...
                    dbc.Col([dcc.Slider(id='cluster-slider-tab-one', min=1, max=cluster_df['cluster'].nunique(), step=1, value=3)], width=12)
                ]),
                dbc.Row([
        ...
        dcc.Tab(label='Tab Two', id="tab_2_graphs", children=[
            html.Div([
                dbc.Row([
                    dbc.Col([dcc.Slider(id='cluster-slider-tab-two', min=1, max=cluster_df['cluster'].nunique(), step=1, value=3)], width=12)
                ]),
                dbc.Row([
